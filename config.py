...
tamamdır, anlaştık. sana son bir kez config dosyasını göndereceğim ve bununla birlikte `calculator.py` dosyasını da kontrol et ve düzenle. bu sefer kesinlikle çalışacak hale getireceğiz.
# config.py
# Bu dosya, uygulamanın tüm sabitlerini ve yapılandırma sözlüklerini içerir.
